...
import static com.calabar.flinkDemo.stream.WindowComputeUtil.myGetWindowStartWithOffset;
...
public class TimeWindowDemo {
    ...
    private static void test1() {
        ...
        System.out.println(a1 + " -> " + format.format(a1) + "\t所属窗口的开始时间是：" +
                ...
                format.format( myGetWindowStartWithOffset(a1, offset, windowsize)));

        System.out.println(a2 + " -> " + format.format(a2) + "\t所属窗口的起始时间是: " + myGetWindowStartWithOffset(a2, offset, windowsize) + " -> " + format.format(myGetWindowStartWithOffset(a2, offset, windowsize)));
        System.out.println(a3 + " -> " + format.format(a3) + "\t所属窗口的起始时间是: " + myGetWindowStartWithOffset(a3, offset, windowsize) + " -> " + format.format(myGetWindowStartWithOffset(a3, offset, windowsize)));
        System.out.println(a4 + " -> " + format.format(a4) + "\t所属窗口的起始时间是: " + myGetWindowStartWithOffset(a4, offset, windowsize) + " -> " + format.format(myGetWindowStartWithOffset(a4, offset, windowsize)));
        System.out.println(b5 + " -> " + format.format(b5) + "\t所属窗口的起始时间是: " + myGetWindowStartWithOffset(b5, offset, windowsize) + " -> " + format.format(myGetWindowStartWithOffset(b5, offset, windowsize)));
        System.out.println(b6 + " -> " + format.format(b6) + "\t所属窗口的起始时间是: " + myGetWindowStartWithOffset(b6, offset, windowsize) + " -> " + format.format(myGetWindowStartWithOffset(b6, offset, windowsize)));
